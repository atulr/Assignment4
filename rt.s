...
# BB#91:                                # %bb3.i.i.i142
	...
	LWI       r5, r1, 180
	SWI       r5, r1, 324
$BB0_92:                                # %_ZN8Trigonum10intersectsER9HitRecord3RayRKi.exit.i144
                                        #   in Loop: Header=BB0_67 Depth=3
	LWI       r5, r1, 332
	ADDI      r5, r5, -1
	SWI       r5, r1, 332
...
$BB0_99:                                # %bb3.i74
	...
	brid      ($BB0_3)
	SWI       r4, r5, 4
$BB0_100:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit147
	...
	bneid     r4, ($BB0_102)
	ADDI      r10, r0, 1
# BB#101:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit147
                                        #   in Loop: Header=BB0_2 Depth=1
	ADDI      r10, r0, 0
$BB0_102:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit147
                                        #   in Loop: Header=BB0_2 Depth=1
	bneid     r10, ($BB0_104)
	NOP    
# BB#103:                               # %bb.i
...
# BB#197:                               # %bb3.i.i.i
	...
	LOAD      r3, r4, 5
	LOAD      r3, r4, 4
$BB0_198:                               # %_ZN8Trigonum10intersectsER9HitRecord3RayRKi.exit.i
                                        #   in Loop: Header=BB0_173 Depth=3
	LWI       r3, r1, 332
	ADDI      r3, r3, -1
	SWI       r3, r1, 332
...
$BB0_205:                               # %bb3.i
	...
	brid      ($BB0_109)
	SWI       r6, r3, 4
$BB0_206:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	LWI       r5, r1, 324
	SWI       r5, r1, 296
	...
	bneid     r5, ($BB0_208)
	ADDI      r6, r0, 1
# BB#207:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	ADDI      r6, r0, 0
$BB0_208:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	bneid     r6, ($BB0_213)
	NOP    
# BB#209:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
...
# BB#210:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	ADDI      r4, r0, 0
$BB0_211:                               # %_ZN3BVH9intersectER9HitRecordR3Ray.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	beqid     r4, ($BB0_213)
	NOP    
...
$BB0_213:                               # %bb96.i
	...
	SWI        r3, r1, 304
	ADD       r5, r3, r0
$BB0_214:                               # %_ZN6Shader10lambertianER3BVH9HitRecord3Ray10PointLight5Color.exit
                                        #   in Loop: Header=BB0_2 Depth=1
	LWI       r4, r1, 432
	LWI       r3, r1, 428
	ADD       r3, r3, r4
